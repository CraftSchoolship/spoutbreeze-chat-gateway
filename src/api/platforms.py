...
async def connect_twitch(
    ...
    await twitch_service.start_connection_for_user(user_id, token_data["access_token"], meeting_id)
...
async def connect_youtube(
    ...
    await youtube_service.start_connection_for_user(user_id, meeting_id)
